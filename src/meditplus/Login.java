...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("No tengo una cuenta");

        bsignup.setBackground(new java.awt.Color(0, 102, 102));
        bsignup.setForeground(new java.awt.Color(255, 255, 255));
        bsignup.setText("Registrarse");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(email, javax.swing.GroupLayout.DEFAULT_SIZE, 299, Short.MAX_VALUE)
    ...
    private void bloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bloginActionPerformed
        ...
        try {
            ...
            if("".equals(email.getText())){
                JOptionPane.showMessageDialog(new JFrame(), "Email es requerido", "Error",
            ...
            if(notFound == 1 && Password.equals(passDb)){
               ...
               JOptionPane.showMessageDialog(new JFrame(), "Email o Contraseña incorrecta", "Error",
                        JOptionPane.ERROR_MESSAGE);
            }
            password.setText("");
